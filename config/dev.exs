...
config :cd_robot, CdRobot.Repo,
  database: Path.expand("../cd_robot_dev.db", __DIR__),
  pool_size: 5,
  stacktrace: true,
...
config :cd_robot, CdRobotWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "yBC4ZtuCzvKczYsbJrxb6eLFve3HSXBmNM3Rk2Aosdi/Zeq1NnQYILGrHqR/Cm+N",
  watchers: [
...
config :cd_robot, dev_routes: true
